...
export class PhysicsTagService extends AbstractBaseTagService {
    ...
    private static readonly baseTags: BaseTag[] = [
        ...
        // Statistics
        {id: TAG_ID.hypothesis, title: "Hypothesis Tests", parent: TAG_ID.statistics},
        ...
        // Physical
        {id: TAG_ID.energetics, title: "Energetics", parent: TAG_ID.physical},
        ...
        {id: TAG_ID.aromaticity, title: "Aromaticity", parent: TAG_ID.organic},
