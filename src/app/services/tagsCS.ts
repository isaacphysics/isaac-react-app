...
export class CsTagService extends AbstractBaseTagService {
    ...
    private static readonly baseTags: BaseTag[] = [
        ...
        {id: TAG_ID.booleanLogic, title: "Boolean logic", parent: TAG_ID.computerSystems, stageOverride: GCSE_COMING_DEC},
        ...
        {id: TAG_ID.programmingLanguages, title: "High- and low-level languages", parent: TAG_ID.computerSystems, stageOverride: GCSE_COMING_DEC},
        {id: TAG_ID.translators, title: "Translators", parent: TAG_ID.computerSystems, stageOverride: GCSE_COMING_DEC},
