...
export class CsTagService extends AbstractBaseTagService {
    ...
    private static readonly baseTags: BaseTag[] = [
        ...
        {id: TAG_ID.maliciousCode, title: "Malicious software", parent: TAG_ID.cyberSecurity, stageOverride: GCSE_COMING_2022},
        ...
        {id: TAG_ID.compression, title: "Compression", parent: TAG_ID.dataAndInformation, stageOverride: GCSE_NEW},
