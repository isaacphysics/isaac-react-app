...
export const determineNextGameboardItem = (currentGameboard: GameboardDTO | null | undefined, currentDocId: string) => {
    if (currentGameboard && currentGameboard.questions) {
