...
export const ALL_TOPICS: AllTopicsDTO = {
    Theory: {
        ...
        "Data structures and algorithms": {
            "Searching, sorting & pathfinding": {comingSoon: true},
            "Complexity": {comingSoon: true},
            "Models of computation": {comingSoon: true, onlyFor: [EXAM_BOARDS.OCR]},
            "Planning and debugging": {comingSoon: true},
            "Data structures (theory)": {comingSoon: true},
        },
        "Computer networks": {
            "Security": {comingSoon: true},
            "Network structure": {comingSoon: true},
            "Network hardware": {comingSoon: true},
            "Communication": {comingSoon: true},
            "Internet": {comingSoon: true},
        },
        "Computer systems": {
            "Boolean logic": {destination: "/topics/boolean_logic"},
            "Architecture": {comingSoon: true},
            "Hardware": {comingSoon: true},
            "Operating systems and software": {comingSoon: true},
            "Translators": {comingSoon: true},
            "Programming languages": {comingSoon: true},
        },
        "Data and information": {
            "Number systems": {comingSoon: true},
            "Number bases": {comingSoon: true},
            "Representation": {comingSoon: true},
            "Transmission": {comingSoon: true},
            "Databases": {comingSoon: true},
            "Big Data": {comingSoon: true},
            "Compression": {comingSoon: true},
            "Encryption": {comingSoon: true},
        },
    },
    Programming: {
        ...
        "Object oriented programming": {
            "Creating objects": {comingSoon: true},
            "OOP concepts": {comingSoon: true},
            "Class diagrams": {comingSoon: true},
        },
