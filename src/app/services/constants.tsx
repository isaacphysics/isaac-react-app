...
export enum ACTION_TYPE {
    ...
    USER_AUTH_SETTINGS_SUCCESS = "USER_AUTH_SETTINGS_SUCCESS",
    USER_AUTH_SETTINGS_FAILURE = "USER_AUTH_SETTINGS_FAILURE",
    USER_PREFERENCES_REQUEST = "USER_PREFERENCES_REQUEST",
    USER_PREFERENCES_SUCCESS= "USER_PREFERENCES_SUCCESS",
    USER_PREFERENCES_FAILURE = "USER_PREFERENCES_FAILURE",
    ...
    USER_INCOMING_PASSWORD_RESET_REQUEST_SUCCESS = "USER_INCOMING_PASSWORD_RESET_REQUEST_SUCCESS",
    USER_INCOMING_PASSWORD_RESET_REQUEST_FAILURE = "USER_INCOMING_PASSWORD_RESET_REQUEST_FAILURE",
