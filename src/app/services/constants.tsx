...
export enum ACTION_TYPE {
    ...
    ACTIVE_AUTHORISATIONS_REQUEST = "ACTIVE_AUTHORISATIONS_REQUEST",
    ACTIVE_AUTHORISATIONS_RESPONSE_SUCCESS = "ACTIVE_AUTHORISATIONS_RESPONSE_SUCCESS",
    ACTIVE_AUTHORISATIONS_RESPONSE_FAILURE = "ACTIVE_AUTHORISATIONS_RESPONSE_FAILURE",
