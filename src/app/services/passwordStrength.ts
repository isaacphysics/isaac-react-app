...
function calculatePasswordStrength(password: string, additionalTerms?: string[]) {
    ...
    const isaacTerms = [
        ...
        "Isaac Physics", "Isaac Chemistry", "Isaac Maths", "Isaac Biology", "Isaac Science",
        "IsaacPhysics", "IsaacChemistry", "IsaacMaths", "IsaacBiology", "IsaacScience",
        "Physics", "Chemistry", "Maths", "Biology", "Phy", "Phys", "Math", "Mathematics", "Physical",
        "isaacphysics.org", "isaacchemistry.org", "isaacmaths.org", "isaacbiology.org", "isaacscience.org",
