import {EXAM_BOARDS, TAG_HIERARCHY, TAG_ID, TAG_LEVEL} from "./constants";
...
const baseTags: BaseTag[] = [
    ...
    {id: TAG_ID.gcseNetworking, title: "Networking", parent: TAG_ID.gcseToALevel, onlyFor: [EXAM_BOARDS.OCR], comingSoon: true},
    ...
    {id: TAG_ID.modelsOfComputation, title: "Models of computation", parent: TAG_ID.dataStructuresAndAlgorithms, onlyFor: [EXAM_BOARDS.OCR], comingSoon: true},
    ...
    {id: TAG_ID.files, title: "Files", parent: TAG_ID.proceduralProgramming, onlyFor: [EXAM_BOARDS.OCR]},
