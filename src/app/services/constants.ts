...
export enum ACTION_TYPE {
    ...
    QUIZ_LOAD_ASSIGNMENT_ATTEMPT_RESPONSE_SUCCESS = "QUIZ_LOAD_ASSIGNMENT_ATTEMPT_RESPONSE_SUCCESS",
    QUIZ_LOAD_ASSIGNMENT_ATTEMPT_RESPONSE_FAILURE = "QUIZ_LOAD_ASSIGNMENT_ATTEMPT_RESPONSE_FAILURE",
