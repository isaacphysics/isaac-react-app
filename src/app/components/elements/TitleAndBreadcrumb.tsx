...
const BreadcrumbTrail = ({
  ...
  if (collectionType === "Gameboard") {
    ...
    breadcrumbHistory.splice(1, 0, Object.assign({}, collectionBreadcrumb, { title: collectionType }));
  }
...
export const formatBreadcrumbItem = (currentPageTitle: string, disallowLaTeX?: boolean) => {
  return <BreadcrumbItem active>{formatBreadcrumbItemTitle(currentPageTitle, disallowLaTeX)}</BreadcrumbItem>;
};
