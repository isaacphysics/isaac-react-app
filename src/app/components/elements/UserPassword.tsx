...
interface UserPasswordProps {
    ...
    validateAndSetPassword: (e: any) => void;
...
export const UserPassword = ({myUser, setMyUser, isValidPassword, validateAndSetPassword, authSettings, setCurrentPassword, passwordResetRequest, resetPasswordIfValidEmail}: UserPasswordProps) => {
    return <CardBody>
