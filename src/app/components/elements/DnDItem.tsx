...
function DropZoneItem({item, id, type, overrideOver, isCorrect}: {item: Immutable<ItemDTO>, id: string, type: "drop-zone" | "item-section", overrideOver?: boolean, isCorrect?: boolean}) {
    ...
    return <Badge id={id} className={classNames("p-1 cloze-item feedback-zone align-middle", {"m-2": type === "item-section", "feedback-showing": isDefined(isCorrect)})} color="cloze" style={style} innerRef={setNodeRef} {...listeners} {...attributes}>
