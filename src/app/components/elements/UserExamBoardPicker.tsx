...
interface UserExamBoardPicker {anonOnly?: boolean; className?: string; hideLabel?: boolean}

export const UserExamBoardPicker = ({anonOnly = false, className, hideLabel = false}: UserExamBoardPicker) => {
