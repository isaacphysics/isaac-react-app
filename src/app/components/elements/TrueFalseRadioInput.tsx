...
export const TrueFalseRadioInput = (props: TrueFalseRadioProps<any>) => {
    ...
    return <RS.FormGroup>
        <RS.Label htmlFor={`${id}-t`} className="w-50">
        ...
        <RS.CustomInput
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                ...
                } else if (stateObject[propertyName]) {
        ...
        />
        <RS.Label htmlFor={`${id}-f`} className="w-50">
        ...
        <RS.CustomInput
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                ...
                } else if (stateObject[propertyName] === false) {
                    delete stateObject[propertyName];
                }
                setStateFunction(Object.assign({}, stateObject));
            }}
            aria-describedby={`${id}-feedback`}
        />
        {invalid && <div id={`${id}-feedback`} className="required-before">
            required
        </div>}
    </RS.FormGroup>
};
