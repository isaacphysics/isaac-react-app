    ...
    return <div className="vertical-center">
        {qrCodeStringBase64SVG && <figure>
            <img
                ...
                alt={t('followThisUrlToJoinTheGroup', 'Follow this URL to join the group: ') + link}
            />
            <figcaption className="text-center pb-3">{t('scanToJoin', 'Scan to join')} {groupName ? <b>{groupName}</b> : t('theGroup', 'the group')}!</figcaption>
        </figure>}
    </div>;
};
