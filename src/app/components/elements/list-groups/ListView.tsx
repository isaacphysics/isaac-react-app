...
export const ConceptListViewItem = ({item, ...rest}: ConceptListViewItemProps) => {
    ...
    const icon: TitleIconProps = {type: "icon", icon: "icon-concept", size: siteSpecific("lg", "md")};
...
export const TopicListViewItem = ({item, ...rest}: TopicListViewItemProps) => {
    ...
    const icon: TitleIconProps = {type: "icon", icon: "icon-topic", alt: "Topic summary page icon", label: "Topic"};
...
export const EventListViewItem = ({item, ...rest}: EventListViewItemProps) => {
    ...
    return <AbstractListViewItem
        icon={{type: "icon", icon: "icon-events", size: "lg"}}
        title={item.title ?? ""}
        subject={itemSubject}
        subtitle={item.subtitle}
        url={url}
...
export const QuizListViewItem = ({item, isQuizSetter, useViewQuizLink, ...rest}: QuizListViewItemProps) => {
    ...
    return <AbstractListViewItem
        icon={{type: "icon", icon: "icon-tests", size: "lg"}}
        title={item.title ?? ""}
        subject={itemSubject}
...
export const QuestionDeckListViewItem = ({item, ...rest}: QuestionDeckListViewItemProps) => {
    ...
    return <AbstractListViewItem
        icon={{type: "icon", icon: "icon-question-deck", size: "lg"}}
...
export const QuickQuizListViewItem = ({item, ...rest}: QuickQuizListViewItemProps) => {
    ...
    return <AbstractListViewItem
        icon={{type: "icon", icon: "icon-question", size: "lg"}}
        title={item.title ?? ""}
        subject={itemSubject}
        subtitle={item.subtitle}
        breadcrumb={breadcrumb}
...
export const GenericListViewItem = ({item, ...rest}: GenericListViewItemProps) => {
    ...
    const icon: TitleIconProps = {type: "icon", icon: "icon-info", size: siteSpecific("lg", "md")};

    if (isAda) {
        icon.label = "Info";
        icon.alt = "IGeneric page icon";
    }
...
export const ShortcutListViewItem = ({item, linkedBoardId, ...rest}: ShortcutListViewItemProps) => {
    ...
    return <AbstractListViewItem
        icon={{type: "icon", icon: icon, size: "lg"}}
        title={item.title ?? ""}
        subject={itemSubject}
        subtitle={subtitle}
        tags={item.tags}
...
export const BookIndexListViewItem = ({item, ...rest}: BookIndexListViewItemProps) => {
    ...
    return <AbstractListViewItem
        {...item}
        icon={{type: "icon", icon: "icon-book", size: "lg"}}
...
export const BookDetailListViewItem = ({item, ...rest}: BookDetailListViewItemProps) => {
    ...
    return <AbstractListViewItem
        {...item}
        icon={{type: "icon", icon: "icon-generic", size: "lg"}}
