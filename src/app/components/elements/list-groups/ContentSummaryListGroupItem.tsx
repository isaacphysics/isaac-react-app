...
export const ContentSummaryListGroupItem = ({item, search, showBreadcrumb, noCaret, contentTypeVisibility, ignoreIntendedAudience}: {
    ...
    switch(item.state) {
        case CompletionState.IN_PROGRESS:
            ...
            questionIcon = <img src="/assets/cs/icons/question-in-progress.svg" alt={questionIconLabel}/>;
            break;
        case CompletionState.ALL_CORRECT:
            questionIconLabel = "Complete question icon";
            questionIcon = <img src="/assets/cs/icons/question-correct.svg" alt={questionIconLabel}/>;
            break;
        case CompletionState.ALL_INCORRECT:
            questionIconLabel = "Incorrect question icon";
            questionIcon = <img src="/assets/cs/icons/question-incorrect.svg" alt={questionIconLabel} width={"24px"}/>;
            break;
        case CompletionState.NOT_ATTEMPTED:
        default:
            questionIconLabel = "Not attempted question icon";
            questionIcon = <img src="/assets/cs/icons/question-not-started.svg" alt={questionIconLabel}/>;
            break;
    }
