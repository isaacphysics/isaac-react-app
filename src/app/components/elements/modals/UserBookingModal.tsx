    ...
    return <Form onSubmit={makeUserBooking} className="mb-4">
        ...
        <span>
            ...
            {(userCanBeBookedOnEvent || userCanBeAddedToWaitingList) &&
                <Input className="btn btn-block btn-secondary border-0 mt-3"
...
export const UserBookingModal = buildActiveModal(
    "user-booking-modal",
    "UserBookingModal",
    ({eventBookingIds, selectedEvent, selectedUser, closeModal}) => ({
