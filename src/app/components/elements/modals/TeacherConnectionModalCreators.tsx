  ...
  return {
    ...
    body: (
      <React.Fragment>
        ...
        <p>
          <small>
            <strong>Remember</strong>: you can always revoke access to your data from the Teacher Connections tab on
            this page.
          </small>
          <br />
          <small>
...
export const revocationConfirmationModal = (userId: number, userToRevoke: UserSummaryWithEmailAddressDTO) => {
  return {
    ...
    body: (
      <React.Fragment>
        <p>
          The user <strong>{extractTeacherName(userToRevoke)}</strong> will no longer be able to access your data.
          <br />
