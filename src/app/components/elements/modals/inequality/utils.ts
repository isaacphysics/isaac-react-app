...
export function generateMathsBasicFunctionsItems(): MenuItemProps[] {
    return [
        ...
        {type: "GraphLine", properties: { type: '→' }, menu: { label: '→', texLabel: true, className: 'graphline' }},
        {type: "GraphLine", properties: { type: '↔' }, menu: { label: '↔', texLabel: true, className: 'graphline double' }},
        {type: "GraphLine", properties: { type: '⤸' }, menu: { label: '⤸', texLabel: true, className: 'graphline self' }},
    ];
}
