...
export const SignupSidebar = ({activeTab} : {activeTab: number}) => {
    ...
    return <ContentSidebar buttonTitle="Create an account">
        ...
        <StyledTabPicker checkboxTitle={"Teacher connections"} checked={activeTab === 3} disabled={activeTab < 3} onClick={() => activeTab === 4 && goBack("connect")}/>
        <StyledTabPicker checkboxTitle={"Preferences"} checked={activeTab === 4} disabled={activeTab !== 4}/>
    </ContentSidebar>;
};
