...
export const SignupSidebar = ({activeTab, sso} : {activeTab: number, sso?: boolean}) => {
    ...
    return <ContentSidebar buttonTitle="Create an account">
        ...
        <StyledTabPicker checkboxTitle={"Age verification"} checked={activeTab === 1} disabled={activeTab < 1 || activeTab > 2} onClick={() => activeTab === 2 && handleSSOBack("/age")}/>
