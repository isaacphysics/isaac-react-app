        ...
        <ShowLoadingQuery query={assignmentQuery} defaultErrorTitle="" thenRender={(assignments: AssignmentDTO[]) => {
            ...
            return <>
                ...
                <search data-testid="my-assignments-sidebar">
                    <h5>{t('searchAssignments', 'Search assignments')}</h5>
                    <Input
                    ...
                    <div className="section-divider"/>
                    <h5 className="mb-4">{t('filterByStatus2', 'Filter by status')}</h5>
                    <ul>
                    ...
                    <h5 className="mt-4 mb-3">{t('filterByGroup2', 'Filter by group')}</h5>
                    ...
                    <h5 className="mt-4 mb-3">{t('filterByAssigner', 'Filter by assigner')}</h5>
