        ...
        <ShowLoadingQuery query={assignmentQuery} defaultErrorTitle="" thenRender={(assignments: AssignmentDTO[]) => {
            ...
            return <>
                ...
                <search data-testid="my-assignments-sidebar">
                    <h3 className="h5">Search assignments</h3>
                    <SearchInputWithIcon
                        outerClassName='my-3'
                    ...
                    <div className="section-divider"/>
                    <h3 className="mb-4 h5">Filter by status</h3>
                    <ul>
                    ...
                    <h3 className="mt-4 mb-3 h5">Filter by group</h3>
                    ...
                    <h3 className="mt-4 mb-3 h5">Filter by assigner</h3>
