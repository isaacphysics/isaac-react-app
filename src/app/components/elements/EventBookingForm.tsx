      ...
      <RS.Card className="mb-3 bg-light">
        <RS.CardBody>
          ...
          <div>
            <RS.Row>
              ...
              <RS.Col md={6}>
                ...
                <RS.Input
                  ...
                  value={
                    Array.from(
                      new Set(targetUser.registeredContexts?.map((rc) => examBoardLabelMap[rc.examBoard!])),
                    ).join(", ") || ""
                  }
                />
              </RS.Col>
            ...
            <RS.Row>
              <RS.Col>
                {editingSelf && targetUser.emailVerificationStatus != "VERIFIED" && !verifyEmailRequestSent && (
                  <RS.Button
                    color="link"
                ...
                {targetUser.emailVerificationStatus != "VERIFIED" && verifyEmailRequestSent && (
                  <span>
                    We have sent an email to {targetUser.email}. Please follow the instructions in the email prior to
                    booking.
                  </span>
                )}
              </RS.Col>
              ...
              <div>
                <RS.Label htmlFor="medical-reqs">
                  ...
                  <RS.UncontrolledPopover trigger="click" placement="bottom" target="dietary-reqs-help">
                    <RS.PopoverBody>
                      For example, it is important for us to know if you have a severe allergy and/or carry an EpiPen,
                      are prone to fainting, suffer from epilepsy...
                    </RS.PopoverBody>
              ...
              <div>
                <RS.Label htmlFor="access-reqs">
                  ...
                  <RS.UncontrolledPopover trigger="click" placement="bottom" target="access-reqs-help">
                    <RS.PopoverBody>
                      For example, please let us know if you need wheelchair access, hearing loop or if we can help with
