...
const PhysicsSearchButton = () => {
    return <button aria-label='Search website' className='d-flex bg-transparent search-button justify-content-center align-items-center'>
...
const AdaSearchButton = () => (
    <Button color="link" aria-label="Search website" className="search-button">
    ...
    return <>
        ...
        <InputGroup id={"header-search-group"} className="d-flex flex-nowrap">
            <Input
                ...
                value={searchText} onChange={setSearchTextAsValue}
            />
            <button className="d-flex align-items-center justify-content-center" aria-label="Search website">
