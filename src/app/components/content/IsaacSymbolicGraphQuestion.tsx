...
import {IsaacSymbolicGraphQuestionDTO, LogicFormulaDTO} from "../../../IsaacApiTypes";
...
const IsaacSymbolicGraphQuestion = ({doc, questionId, readonly}: IsaacQuestionProps<IsaacSymbolicGraphQuestionDTO>) => {
...
export default IsaacSymbolicGraphQuestion;
