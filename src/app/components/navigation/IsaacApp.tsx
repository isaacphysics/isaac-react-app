...
import {AssignmentTimelinePage} from "../pages/AssignmentTimelinePage";
        ...
        <main id="main" role="main" className="flex-fill content-body">
            <ErrorBoundary FallbackComponent={ClientError}>
                <Suspense fallback={<Loading/>}>
                    ...
                    <TrackedRoute exact path="/assignment_timeline" ifUser={isTeacher} component={AssignmentTimelinePage} />
