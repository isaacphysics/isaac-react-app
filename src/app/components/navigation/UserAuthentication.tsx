...
import { isDefined, isNotTeacherPending, isTeacherOrAbove, isTutorOrAbove, KEY, persistence, TEACHER_REQUEST_ROUTE } from "../../services";
...
export const RequireAuth = ({auth, element}: RequireAuthProps) => {
    ...
    if (!isNotTeacherPending(user) && auth.name) {
