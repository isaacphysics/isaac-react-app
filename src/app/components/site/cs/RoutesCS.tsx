...
import {isEventLeaderOrStaff, isTeacherOrAbove, STAGE} from "../../../services";
...
export const RoutesCS = [
    ...
    <TrackedRoute key={key++} exact path="/my_markbook/:assignmentId" ifUser={isTeacherOrAbove} component={SingleAssignmentProgress} />,
