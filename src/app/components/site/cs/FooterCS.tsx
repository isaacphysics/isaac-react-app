                    ...
                    <Col xs={"auto"} className={"me-7 mb-4 mb-md-0"}>
                        <Link to="/" className="d-block">
                            <img
                                ...
                                alt={i18next.t('adaComputerScienceHomepage', 'Ada Computer Science homepage')}
                            />
                        </Link>
                    </Col>
                ...
                <div className='footer-links footer-bottom pb-7'>
                    <Row className="justify-content-between">
                        <Col xs={{size: 12}} md={{size: 7, order: 2}} lg={{size: 8}} xl={{size: 9}} className="text-cs-white text-start text-md-end">
                            <p>All teaching materials on this site are available under a <a href="https://creativecommons.org/licenses/by-nc-sa/4.0" className="d-inline link-light text-white">CC BY-NC-SA 4.0</a> license, except where otherwise stated.</p>
                        </Col>
                            ...
                            <Row className="align-items-center">
                                <Col>
                                    <a href="https://www.cam.ac.uk/" target="_blank" rel="noopener">
                                        <img src="/assets/common/logos/university_of_cambridge.svg" alt={i18next.t('universityOfCambridgeWebsite', 'University of Cambridge website')} className='img-fluid footer-org-logo' />
                                    </a>
                                </Col>
                                <Col>
                                    <a href="https://www.raspberrypi.org/" target="_blank" rel="noopener">
                                        <img src="/assets/common/logos/ada_rpf_icon.svg" alt={i18next.t('raspberryPiWebsite', 'Raspberry Pi website')} className='img-fluid footer-org-logo' />
                                    </a>
                                </Col>
                            </Row>
                        </Col>
