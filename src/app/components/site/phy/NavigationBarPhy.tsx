...
export const NavigationBarPhy = () => {
    ...
    return <NavigationBar>
        <NavigationSection title={<>My Isaac {assignmentBadge}</>}>
            ...
            <LinkItem to="/quizzes" muted={!isLoggedIn(user)}>My Tests</LinkItem>
        </NavigationSection>
        ...
        {isTeacher(user) && <NavigationSection title="Teach">
            ...
            <LinkItem to="/set_quizzes">Set Tests</LinkItem>
            <LinkItem to="/set_quizzes#manage">Manage Tests</LinkItem>
        </NavigationSection>}
