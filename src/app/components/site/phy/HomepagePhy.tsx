                ...
                <Container className="pt-4">
                    <Row className="mt-sm-4">
                        ...
                        <Col lg={7} className={above["lg"](deviceSize) ? `align-items-stretch d-flex flex-column` : ""}>
                            ...
                            <div className={`h-100 ps-lg-4 content-video-container w-100 ${user?.loggedIn ? "pt-1 pt-sm-2 pt-lg-2" : "pt-4 pt-lg-3"} ${userContext.cookieConsent?.youtubeCookieAccepted ?? false ? "ratio-16x9" : ""}`}>
