...
import {selectors, useAppSelector, useGetTopicSummaryQuery} from "../../state";
...
export const Topic = withRouter(({match: {params: {topicName}}}: {match: {params: {topicName: TAG_ID}}}) => {
    ...
    const topicQuery = useGetTopicSummaryQuery(topicName);
    const topicPage = topicQuery.data;
    ...
    const linkedRelevantGameboards = topicPage?.linkedGameboards;
