        ...
        thenRender={supertypedDoc => {
            ...
            return <GameboardContext.Provider value={navigation.currentGameboard}>
                <Container className="no-shadow" data-bs-theme={pageContext?.subject ?? doc.subjectId}>
                    ...
                    <SidebarLayout>
                        {isDefined(gameboardId) ? <GameboardQuestionSidebar id={gameboardId} title={gameboard?.title || ""} questions={gameboard?.contents || []} wildCard={gameboard?.wildCard} currentQuestionId={questionId}/>
