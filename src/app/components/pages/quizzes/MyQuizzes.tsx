...
export const PastTestsToggle = ({showCompleted, setShowCompleted, setQuizStatuses}: {showCompleted: boolean, setShowCompleted: (show: boolean) => void, setQuizStatuses: React.Dispatch<React.SetStateAction<QuizStatus[]>>}) => {
