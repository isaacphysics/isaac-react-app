...
const PhyTable = (props: SetAssignmentsTableProps) => {
    ...
    const tableHeader = <tr className="my-gameboard-table-header">
        ...
        <SortItemHeader defaultOrder={BoardOrder.title} reverseOrder={BoardOrder["-title"]} currentOrder={boardOrder} setBoardOrder={setBoardOrder}>
            Board name
        </SortItemHeader>
...
const CSTable = (props: SetAssignmentsTableProps) => {
    ...
    const tableHeader = <tr className="my-gameboard-table-header">
        <th>Groups</th>
        <SortItemHeader colSpan={2} defaultOrder={BoardOrder.title} reverseOrder={BoardOrder["-title"]} currentOrder={boardOrder} setBoardOrder={setBoardOrder}>
            Quiz name
        </SortItemHeader>
