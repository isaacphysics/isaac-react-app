...
export const Alevel = () => {
    ...
    return <Container>
        ...
        <Row className="card-deck teacher-feature-body my-3">
            ...
            <IsaacCard doc={{title: "Maths for Sciences", subtitle: "The collection of our Maths questions on the platform.",
        ...
        <Row className="card-deck teacher-feature-body mb-5 mt-3">
            ...
            <IsaacCard doc={{title: "Quantum Mechanics Prime", subtitle: "A first year university introduction to quantum mechanics.",
