...
export const RegistrationSetDetailsSSO = ({userRole}: RegistrationSetDetailsProps) => {
    ...
    const register = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (familyNameIsValid && givenNameIsValid &&
                    ...
                    rightColumn = {<Form onSubmit={register}>
                        ...
                        <Row className="justify-content-end">
                            <Col className="d-flex justify-content-end" xs={12} sm={siteSpecific(3,4)} lg={6}>
                                <Button className="mt-2 w-100" color="keyline" disabled onClick={goBack}>Back</Button>
                            </Col>
