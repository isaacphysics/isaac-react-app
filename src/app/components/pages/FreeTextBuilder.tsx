...
function generateDefaultChoice() {
  ...
  return {
    ...
    explanation: {
      type: "content",
      children: [{ type: "content", value: `Match ${choiceNumber}`, encoding: "markdown" }],
      encoding: "markdown",
    },
  };
}
...
export const FreeTextBuilder = () => {
  ...
  const [questionChoices, setQuestionChoices] = useState<(FreeTextRule & { choiceNumber: number })[]>([
  ...
  const [testCases, setTestCases] = useState<(TestCaseDTO & { testCaseNumber: number })[]>([
    ...
    testCaseResponses
      .map((response) =>
        Object.assign(response, {
          match: response.expected !== undefined ? response.expected === response.correct : undefined,
        }),
      )
                        ...
                        <tr key={choice.choiceNumber}>
                            ...
                            <RS.Label className="mb-3 w-100">
                              ...
                              <div className="d-flex align-items-center">
                                <RS.Input
                                  ...
                                  onChange={(e) =>
                                    setQuestionChoices(
                                      questionChoices.map((c) => (choice == c ? { ...c, value: e.target.value } : c)),
                                    )
                                  }
                                />
                                  ...
                                  onClick={() =>
                                    setQuestionChoices(
                                      questionChoices.map((c) =>
                                        choice == c ? { ...c, caseInsensitive: !c.caseInsensitive } : c,
                                      ),
                                    )
                                  }
                                >
                              ...
                              <RS.Col xs={3} className="text-center">
                                <RS.Button
                                  ...
                                  onClick={() =>
                                    setQuestionChoices(
                                      questionChoices.map((c) =>
                                        choice == c ? { ...c, allowsAnyOrder: !c.allowsAnyOrder } : c,
                                      ),
                                    )
                                  }
                                >
                              ...
                              <RS.Col xs={3} className="text-center">
                                <RS.Button
                                  ...
                                  onClick={() =>
                                    setQuestionChoices(
                                      questionChoices.map((c) =>
                                        choice == c ? { ...c, allowsExtraWords: !c.allowsExtraWords } : c,
                                      ),
                                    )
                                  }
                                >
                              ...
                              <RS.Col xs={3} className="text-center">
                                <RS.Button
                                  ...
                                  onClick={() =>
                                    setQuestionChoices(
                                      questionChoices.map((c) =>
                                        choice == c ? { ...c, allowsMisspelling: !c.allowsMisspelling } : c,
                                      ),
                                    )
                                  }
                                >
                          ...
                          <td className="align-middle">
                            <RS.Button
                              ...
                              onClick={() =>
                                setQuestionChoices(
                                  questionChoices.map((c) => (choice == c ? { ...c, correct: !c.correct } : c)),
                                )
                              }
                            >
                              ...
                              {isEditableExplanation(choice.explanation) ? (
                                <RS.Input
                                  ...
                                  onChange={(event) => {
                                    ...
                                    setQuestionChoices(
                                      questionChoices.map((c) => (choice == c ? { ...c, explanation } : c)),
                                    );
                                  }}
                                />
                              ) : (
                          ...
                          <td>
                            <button
                              ...
                              onClick={() =>
                                setQuestionChoices(questionChoices.filter((choiceInState) => choice !== choiceInState))
                              }
                            >
                              ×
                            </button>
                          ...
                          <tr key={testCase.testCaseNumber}>
                            <td className="w-10 text-center align-middle">
                              <RS.Button
                                ...
                                onClick={() =>
                                  setTestCases(
                                    testCases.map((tc) => (testCase == tc ? { ...tc, expected: !tc.expected } : tc)),
                                  )
                                }
                              >
                            ...
                            <td
                              className={`w-10 text-center align-middle ${matchFailure ? "alert-danger" : "bg-light"}`}
                            >
                            ...
                            <td className={`${matchFailure ? "alert-danger" : "bg-light"}`}>
                              <button
                                ...
                                aria-label="Delete matching rule"
                                onClick={() =>
                                  setTestCases(testCases.filter((testCaseInState) => testCase !== testCaseInState))
                                }
                              >
                                ×
                              </button>
