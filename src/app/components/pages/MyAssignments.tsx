...
export const MyAssignments = () => {
  ...
  const { data: assignments } = isaacApi.endpoints.getMyAssignments.useQuery(undefined, {
  ...
  const pageHelp = (
    <span>
      ...
      <br />
      Unfinished overdue assignments will show in Assignments To Do for 5 days after they are due, after which they move
      to Older Assignments.
    </span>
  );
            ...
            <Row>
              ...
              <Col sm={6} lg={{ size: 2, offset: 4 }}>
                <Label className="w-100">
                  ...
                  >
                    {["All", ...getDistinctAssignmentGroups(assignments)].map((group) => (
              ...
              <Col sm={6} lg={2}>
                <Label className="w-100">
                  ...
                  >
                    {["All", ...getDistinctAssignmentSetters(assignments)].map((setter) => (
