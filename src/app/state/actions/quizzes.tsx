...
const throttleDispatch = throttle(async (dispatch: Dispatch<Action>, quizAttemptId: number, questionId: string, attempt) => {
    ...
    if (questions) {
        ...
        if (question) {
            ...
            if (attempt && question.canSubmit) {
                throttleDispatch(dispatch, quizAttemptId, questionId, attempt);
            }
        }
    }
};
