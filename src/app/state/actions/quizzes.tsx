...
export const submitQuizQuestionIfDirty =
  (quizAttemptId: number, questionId: string) => async (dispatch: Dispatch<Action>, getState: () => AppState) => {
    // Get current answer
...
export const loadStudentQuizAttemptFeedback =
  (quizAttemptId: number, userId: number) => async (dispatch: Dispatch<Action>) => {
...
export const returnQuizToStudent =
  (quizAssignmentId: number, studentId: number) => async (dispatch: Dispatch<Action>) => {
...
export const updateQuizAssignmentFeedbackMode =
  (quizAssignmentId: number, quizFeedbackMode: QuizFeedbackMode) => async (dispatch: Dispatch<Action>) => {
