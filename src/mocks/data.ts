...
export const mockUser = {
    ...
    dateOfBirth: new Date(2000, 0, 1).getTime(),
    gender: "MALE",
...
export const buildMockStudent = <T extends number>(id: T extends (typeof mockUser.id) ? `Student ID cannot be the same as the mockUser: ${typeof mockUser.id}` : T) => {
    ...
    return {
        ...
        dateOfBirth: new Date(2010, 0, 1).getTime(),
...
export const buildMockTeacher = <T extends number>(id: T extends (typeof mockUser.id) ? `Teacher ID cannot be the same as the mockUser: ${typeof mockUser.id}` : T) => {
    ...
    return {
        ...
        dateOfBirth: new Date(1980, 0, 1).getTime(),
        gender: id as number % 2 === 0 ? "MALE" : "FEMALE",
        registrationDate: DAYS_AGO(new Date(SOME_FIXED_FUTURE_DATE), 50),
        role: "TEACHER",
        schoolOther: "N/A",
...
export const mockRegressionTestQuestionParts = [
    {
        "id": "_regression_test_acc_quick_q",
        "type": "content",
        "children": [
            {
    ...
    {
        "id": "_regression_test_acc_multi_q",
        "type": "content",
        "children": [
            {
    ...
    {
        "id": "_regression_test_acc_numeric_q",
        "type": "content",
        "children": [
            {
    ...
    {
        "id": "_regression_test_acc_symbolic_q",
        "type": "content",
        "children": [
            {
    ...
    {
        "id": "_regression_test_acc_chemistry_q",
        "type": "content",
        "children": [
            {
    ...
    {
        "id": "_regression_test_acc_stringmatch_q",
        "type": "content",
        "children": [
            {
    ...
    {
        "id": "_regression_test_acc_freetext_q",
        "type": "content",
        "children": [
            {
    ...
    {
        "id": "_regression_test_acc_logic_question",
        "type": "content",
        "children": [
            {
    ...
    {
        "id": "_regression_test_acc_item_q",
        "type": "content",
        "children": [
            {
    ...
    {
        "id": "_regression_test_acc_parsons_q",
        "type": "content",
        "children": [
            {
    ...
    {
        "id": "_regression_test_acc_cloze_q",
        "type": "content",
        "children": [
            {
    ...
    {
        "id": "_regression_test_acc_figure_numbering",
        "type": "content",
        "children": [
            {
                "type": "content",
    ...
    {
        "id": "_regression_test_acc_coordinates",
        "type": "content",
        "children": [
            {
