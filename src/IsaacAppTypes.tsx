...
export type Action =
    ...
    | {type: ACTION_TYPE.ADMIN_USER_AUTHORISATIONS_REQUEST}
    | {type: ACTION_TYPE.ADMIN_USER_AUTHORISATIONS_RESPONSE_SUCCESS; authorisations: ApiTypes.UserSummaryWithEmailAddressDTO[]}
    | {type: ACTION_TYPE.ADMIN_USER_AUTHORISATIONS_RESPONSE_FAILURE}
    | {type: ACTION_TYPE.ADMIN_USER_AUTHORISATIONS_OTHER_USERS_REQUEST}
    | {type: ACTION_TYPE.ADMIN_USER_AUTHORISATIONS_OTHER_USERS_RESPONSE_SUCCESS; otherUserAuthorisations: ApiTypes.UserSummaryDTO[]}
    | {type: ACTION_TYPE.ADMIN_USER_AUTHORISATIONS_OTHER_USERS_RESPONSE_FAILURE}
