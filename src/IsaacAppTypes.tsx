...
export type Action =
    ...
    | {type: ACTION_TYPE.GROUP_PROGRESS_RESPONSE_SUCCESS; group: ApiTypes.UserGroupDTO; progress: ApiTypes.UserGameboardProgressSummaryDTO[]}
    | {type: ACTION_TYPE.GROUP_PROGRESS_RESPONSE_FAILURE}
