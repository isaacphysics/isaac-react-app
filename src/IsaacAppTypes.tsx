...
export type Action =
    ...
    | {type: ACTION_TYPE.INTERACTIVE_VIDEO_REQUEST}
    | {type: ACTION_TYPE.INTERACTIVE_VIDEO_RESPONSE_SUCCESS; video: ApiTypes.H5pVideoDTO}
    | {type: ACTION_TYPE.INTERACTIVE_VIDEO_RESPONSE_FAILURE}
