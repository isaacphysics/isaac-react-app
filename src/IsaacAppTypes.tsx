...
export type Action =
    ...
    | {type: ACTION_TYPE.QUESTION_MOST_RECENT_RESPONSE_SUCCESS; questions: ApiTypes.GameboardItem[]}
    | {type: ACTION_TYPE.QUESTION_MOST_RECENT_RESPONSE_FAILURE}

    | {type: ACTION_TYPE.QUESTION_EASIEST_UNSOLVED_REQUEST}
    | {type: ACTION_TYPE.QUESTION_EASIEST_UNSOLVED_RESPONSE_SUCCESS; questions: ApiTypes.GameboardItem[]}
