...
export type Action =
    ...
    | {type: ACTION_TYPE.MY_QUESTION_ANSWERS_IDS_REQUEST}
    | {type: ACTION_TYPE.MY_QUESTION_ANSWERS_IDS_RESPONSE_SUCCESS; myAnsweredQuestionsIds: ApiTypes.AnsweredQuestionsIds}
    | {type: ACTION_TYPE.MY_QUESTION_ANSWERS_IDS_RESPONSE_FAILURE}
