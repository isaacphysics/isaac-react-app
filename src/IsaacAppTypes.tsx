...
export type Action =
    ...
    | {type: ACTION_TYPE.ADMIN_SEND_EMAIL_REQUEST_SUCCESS}
    | {type: ACTION_TYPE.ADMIN_SEND_EMAIL_REQUEST_FAILURE}

    | {type: ACTION_TYPE.ADMIN_SEND_EMAIL_WITH_IDS_REQUEST}
    | {type: ACTION_TYPE.ADMIN_SEND_EMAIL_WITH_IDS_REQUEST_SUCCESS}
    | {type: ACTION_TYPE.ADMIN_SEND_EMAIL_WITH_IDS_REQUEST_FAILURE}
