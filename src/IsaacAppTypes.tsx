...
export type Action =
    ...
    | {type: ACTION_TYPES.USER_INCOMING_PASSWORD_RESET_REQUEST}
    | {type: ACTION_TYPES.USER_INCOMING_PASSWORD_RESET_REQUEST_SUCCESS}
    | {type: ACTION_TYPES.USER_INCOMING_PASSWORD_RESET_REQUEST_FAILURE; errorMessage: string}
    | {type: ACTION_TYPES.USER_PASSWORD_RESET_REQUEST_SUCCESS}
    | {type: ACTION_TYPES.USER_PASSWORD_RESET}
    | {type: ACTION_TYPES.USER_PASSWORD_RESET_SUCCESS}
    | {type: ACTION_TYPES.USER_PASSWORD_RESET_FAILURE; errorMessage: string}
